...
const ERROR_MESSAGES: Record<string, string> = {
  no_account:     'No account found for that email. Please create an account first.',
  already_exists: 'An account with that email already exists. Please sign in instead.',
};
      ...
      <div className="signin-root">
            ...
            {activeTab === 'signin' ? (
              ...
              <>
                <div className="tab-header">
                  ...
                  <p>Enter your details to get started with UnSub</p>
                </div>
                ...
                <button
                  ...
                  className={`btn-main${(name.trim() && email.trim() && password.trim() && !loading) ? '' : ' disabled'}`}
        ...
        <div className="right-panel">
          ...
          <div className="right-bottom-text">
            <div className="divider"><span>secure · encrypted · no data shared</span></div>
            <p className="privacy-note">
              UnSub keeps your account <strong>private</strong>.<br/>
